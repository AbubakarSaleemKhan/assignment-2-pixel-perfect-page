  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen pt-8 pb-8 space-y-10 -mt-20 w-[990px] m-auto">
      ...
      <div className="flex flex-col items-center text-center w-[550px] p-12 space-y-4">
        <h5 className="text-blue-500 text-[16px] leading-[24px] tracking-[0.1px] font-montserrat mt-24">
          Welcome
        </h5>
        ...
        <div className="flex space-x-2 pt-4">
          ...
          <button className="rounded-[5px] px-[25px] py-2 border border-[#23A6F0] text-blue-500 text-[14px] leading-[22px] tracking-[0.2px] font-montserrat">
            Learn More
          </button>
        </div>
      </div>
